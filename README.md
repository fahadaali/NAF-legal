...
| **التصفية** | حالُ الاسترجاع (`retrieval_status`، وتاريخا النفاذ والإلغاء المجدول مقيَّمَين وقت الاستعلام) **في طبقة الاسترجاع لا في الواجهة** — فلا يتجاوزها تقرير ولا أتمتة ولا واجهة برمجية |

التفصيل والحقول والمسارات في **[`docs/legal-import.md`](docs/legal-import.md)**، ووثيقة الاستيراد والتشغيل كما وردت من المُرسِل — بإصدارها السادس وما يخصّ هذا المستودع في رأسها — في **[`docs/IMPORT-RUNBOOK.md`](docs/IMPORT-RUNBOOK.md)**.
