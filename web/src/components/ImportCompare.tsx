    ...
    <div className="modal-overlay" onClick={onCancel}>
      <div className="modal-card intake" {...modalCardProps}>
        ...
        <div className="modal-body intake-body">
          ...
          {/* الغائب عن الملف يُحصى هنا ولا يُحذف: الحذف سؤالٌ مستقلّ في ختام
              الملف، بعد أن يُكتب كلُّه (§8). وقبل ذلك يجعل ملفٌّ جزئيّ سائرَ
              النظام «غائباً»، والحذف على هذا الظنّ يمحو نظاماً كاملاً. */}
          {diff.missing > 0 ? (
            <p>مواد قائمة في القاعدة ولا وجود لها في هذا الملف — يُعرض حذفها بعد اكتمال استيراده</p>
          ) : null}
