/* ============================================================
   ...
   المرجع الوحيد: `naf-icons.md` من `fahadaali/naf-ui`. **والإصدارُ في
   `.naf-version` وحده** — كان مكتوباً هنا أيضاً (`v1.42.0`) والملفُّ يقول
   غيره (`v1.43.0`)، فصار في المستودع إصداران مُعلَنان لسجلٍّ واحد. ورقمُ
   الإصدار عقد (§9)، ورقمان لعقدٍ واحد أسوأ من غياب الرقم.
